...
// ── Default Export (required for Pi extension) ────────────────────────────

/**
 * No-op extension - this module exists solely as a utility for other extensions.
 * The default export satisfies Pi's requirement that all extension files export
 * a factory function, even though this file is meant to be imported, not loaded.
 */
export default function createThemeMapExtension() {
	return {};
}
