import.meta.url = "file:///Users/kentaylor/.pi/agent/git/github.com/ktappdev/pi-fusion/src/format.ts";
...
export function formatResult(analysis, responses, failed, details) {
    const lines = [];
