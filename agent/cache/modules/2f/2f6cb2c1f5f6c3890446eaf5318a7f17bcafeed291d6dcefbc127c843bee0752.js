import.meta.url = "file:///Users/kentaylor/.pi/agent/extensions/questionnaire.ts";
...
export default function questionnaire(pi) {
    pi.registerTool({
        name: "questionnaire",
        label: "Questionnaire",
        ...
        async execute (_toolCallId, params, _signal, _onUpdate, ctx) {
            ...
            const result = await ctx.ui.custom((tui, theme, _kb, done)=>{
                ...
                function submit(cancelled, timedOut = false) {
                    if (timeoutId) {
                ...
                function saveAnswer(questionId, value, label, wasCustom, index) {
            ...
            if (result.timedOut) {
                return {
                    content: [
                        {
                            type: "text",
                            text: "Questionnaire timed out - user did not respond"
                        }
                    ],
                    details: {
                        ...result,
