import.meta.url = "pi://@earendil-works/pi-coding-agent";
// Auto-generated npm proxy stub (Pattern 4) for "@earendil-works/pi-coding-agent"
const __pkg = "@earendil-works/pi-coding-agent";
const __handler = {
  get(_target, prop) {
...
export const convertToLlm = __stub;
export const serializeConversation = __stub;
