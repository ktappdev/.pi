import.meta.url = "file:///Users/kentaylor/.pi/agent/git/github.com/ktappdev/pi-threading/src/index.ts";
...
export default function(pi) {
    ...
    pi.registerFlag("thread-role", {
        type: "string",
        description: "Role label for this thread (e.g. dev, qa) — targetable via thread_send role:<role>"
    });
    ...
    pi.registerFlag("thread-journal-model", {
        type: "string",
        description: "Model for journal fork entries (e.g. deepseek/deepseek-chat). Default: the thread's own model — a pinned model must resolve on this machine or journaling fails."
    });
